...
(function($) {
  $(document).ready(function() {
    ...
    let yaySMTPAmazonSESPage = YaySmtpAmazonSESGetParam("page");
    let yaySMTPAmazonSESEmailLogTab = "email-logs";
    if (
      yaySMTPAmazonSESPage == "yaysmtp-amazonses" &&
      yaySMTPAmazonSESEmailLogTab == "email-logs"
    ) {
      let page = $(
    ...
    //     type: "POST",
    //     data: {
    //       action: yay_smtp_amazonses_prefix + "_gmail_remove_auth",
    //       nonce: yay_smtp_amazonses_wp_data.ajaxNonce
    //     },
    //     beforeSend: function() {
    //       YaySmtpAmazonSESSpinner("yay-smtp-wrap", true);
    ...
    //     type: "POST",
    //     data: {
    //       action: yay_smtp_amazonses_prefix + "_yoho_remove_auth",
    //       nonce: yay_smtp_amazonses_wp_data.ajaxNonce
    //     },
    //     beforeSend: function() {
    //       YaySmtpAmazonSESSpinner("yay-smtp-wrap", true);
    ...
    $(yay_smtp_amazonses_class_obj + " .mail-setting-redirect").click(function(
      e
    ) {
      e.preventDefault();
      $(yay_smtp_amazonses_class_obj + ".yay-smtp-wrap.mail-logs").hide();
  ...
  jQuery.ajax({
    ...
    success: function(results) {
      ...
      data.forEach(function(item) {
        ...
        html +=
          '<td class="table-item is-sorted to-col ' + showToColClass + '">';
        emailTo.forEach(function(email_val) {
          html += "<span>" + email_val + "</span><br>";
        });
        html += "</td>";

        html += '<td class="table-item status-col ' + showStatusColClass + '">';
        html +=
